...
public interface DualMap<K, V> {
	/**
	 * Associates the specified value with the specified key in this dual map. After
	 * dualmap.put(key, value) is performed, then dualmap.get(key) should return
	 * value and dualmap.reverseGet(value) should return key.
	 * <p>
	 * If the dual map previously contained a mapping for the key or the value, the
	 * old association(s) should be removed.
	 * 
	 * @param key
	 ...
	 * present. After dualmap.put(key, value) and dualmap.remove(key, value), then
	 * dualmap.get(key) should return null and dualmap.reverseGet(value) should
	 * return null.
	 * 
	 * @param key
	...
	/**
	 * Returns the value that maps from the specified key, or null if this dual map
	 * contains no mapping for the key.
	 * 
	 * @param key
	 *            the key that maps to the value that should be returned
	 * @return the value that maps from the specified key, or null if this dual map
	 *         contains no mapping for the key
	 */
	public V get(K key);

	/**
	 * Returns the key that maps to the specified value, or null if this dual map
